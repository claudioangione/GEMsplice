...
function [v, fmax, fmin, fmax_max, fmax_min, fmin_max, fmin_min, v1max_max, v1max_min, v1min_max, v1min_min] = flux_balance_trilevel(fbamodel, quiet)
...
[v1min, fmin] = glpk(fbamodel.g, A, b, fbamodel.lb, fbamodel.ub, ctype, vartype, 1);
[v1max, fmax] = glpk(fbamodel.g, A, b, fbamodel.lb, fbamodel.ub, ctype, vartype, -1);
...
[v1min_min, fmin_min] = glpk(fbamodel.h, A, b, fbamodel.lb, fbamodel.ub, ctype, vartype, 1);
[v1min_max, fmin_max] = glpk(fbamodel.h, A, b, fbamodel.lb, fbamodel.ub, ctype, vartype, -1);
...
[v1max_min, fmax_min] = glpk(fbamodel.h, A, b, fbamodel.lb, fbamodel.ub, ctype, vartype, 1);
[v1max_max, fmax_max] = glpk(fbamodel.h, A, b, fbamodel.lb, fbamodel.ub, ctype, vartype, -1);
